...
class AIAgent:
    ...
    def _looks_like_codex_terminal_refusal(
        self,
        user_message: str,
        assistant_content: str,
        messages: List[Dict[str, Any]],
    ) -> bool:
        """Forwarder — see ``agent.agent_runtime_helpers.looks_like_codex_terminal_refusal``."""
        from agent.agent_runtime_helpers import looks_like_codex_terminal_refusal
        return looks_like_codex_terminal_refusal(
